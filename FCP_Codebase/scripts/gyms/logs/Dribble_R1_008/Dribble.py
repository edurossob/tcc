...
class Dribble(gym.Env):
    ...
    def step(self, action):
        ...
        delta_b_dist = (b_dist - self.last_b_dist) 
        delta_b_x = self.last_b_x - b_x
        ...
        reward = 0.05 * math.exp(-b_dist) + 2*delta_b_x
...
# Train start:    30/10/2024 17:37:37
# Train end:      31/10/2024 00:18:06
# Train duration: 6:40:28