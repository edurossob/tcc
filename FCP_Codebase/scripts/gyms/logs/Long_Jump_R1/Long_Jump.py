...
class Long_Jump(gym.Env):
    ...
    def step(self, action):
        ...
        terminal = (r.cheat_abs_pos[2] < 0.3 or self.step_counter > 400) and not touched_the_floor
...
# Train start:    22/07/2024 21:14:12
# Train end:      24/07/2024 19:07:54
# Train duration: 1 day, 21:53:42