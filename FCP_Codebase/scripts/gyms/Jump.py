...
----------
- class Jump: implements an OpenAI custom gym
...
class Jump(gym.Env):
    ...
    def reset(self):
        ...
        # memory variables
        self.lastz = r.loc_head_z
        self.maxz = r.loc_head_z
    ...
    def step(self, action):
        ...
        height = r.loc_head_z - self.lastz
        
        reward = max(height, 0) # Allows robot to get lower to prepare the jump
        self.lastz = r.loc_head_z
...
class Train(Train_Base):
    ...
    def train(self, args):
        ...
        learning_rate = 3e-4
        folder_name = f'Jump_R{self.robot_type}'
        ...
        def init_env(i_env):
            def thunk():
                return Jump( self.ip , self.server_p + i_env, self.monitor_p_1000 + i_env, self.robot_type, False )
            return thunk
    ...
    def test(self, args):
        ...
        env = Jump( self.ip, self.server_p-1, self.monitor_p, self.robot_type, True )
