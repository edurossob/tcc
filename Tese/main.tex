...
% título
\title{Training motor skills for a simulated Robocup 3D humanoid robot using Reinforcement Learning}
...
\include{3-related-work/texto}			% estado da arte
